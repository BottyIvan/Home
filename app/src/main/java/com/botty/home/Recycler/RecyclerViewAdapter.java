package com.botty.home.Recycler;
...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_ITEM) {
            ...
            View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_widget, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof HeaderViewHolder) {
            ...
            itemViewHolder.itemText.setText("Widget space Item " + position);
    ...
    private class FooterViewHolder extends RecyclerView.ViewHolder {
        ...
        public FooterViewHolder(View view) {
            super(view);
            footerText = (TextView) view.findViewById(R.id.header_text);
        }
    }
